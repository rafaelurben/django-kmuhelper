...
urlpatterns = [
    ...
    path('bestellung/<object_id>/duplizieren', views.bestellung_duplizieren, name='bestellung-duplizieren'),
    path('bestellung/<object_id>/zu-lieferung', views.bestellung_zu_lieferung, name='bestellung-zu-lieferung'),
