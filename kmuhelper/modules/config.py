    ...
    return {
        ...
        'app_list': [{
            ...
            'models': [
                ...
                } for model in get_models(module.get('model_names')) if (
                    request.user.has_perm(f"kmuhelper.view_{model._meta.model_name}") or
                    request.user.has_perm(f"kmuhelper.change_{model._meta.model_name}")
                )
            ],
