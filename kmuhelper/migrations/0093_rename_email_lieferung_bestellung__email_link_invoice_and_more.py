...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='produkt',
            name='categories',
            field=models.ManyToManyField(related_name='products', through='kmuhelper.ProduktProduktkategorieVerbindung', to='kmuhelper.produktkategorie', verbose_name='Kategorie'),
        ),
    ]
