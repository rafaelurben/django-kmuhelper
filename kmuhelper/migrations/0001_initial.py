    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datum",
                    models.DateTimeField(auto_now_add=True, verbose_name="Erfasst am"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Sobald eine Bestellung als versendet markiert wurde, kann sie nicht mehr bearbeitet werden! (Ausgenommen Status/Bezahlt) Ausserdem werden die Produkte aus dem Lagerbestand entfernt.",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Bitte gib hier einen Trackinglink der Schweizer Post ein. (optional)",
                        max_length=25,
                        validators=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Sobald eine Bestellung als bezahlt markiert wurde, kann sie nicht mehr bearbeitet werden! (Ausgenommen Status/Versendet/Trackingnummer)",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="Wird auf der Rechnung gedruckt.",
                        verbose_name="Rechnungsnotiz",
                    ),
                ),
                (
                    "notiz",
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="Nur für eigene Zwecke.",
                        verbose_name="Notiz",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True, default="", max_length=50, verbose_name="Vorname"
                    ),
                ),
                (
                    "rechnungsadresse_nachname",
                    models.CharField(
                        blank=True, default="", max_length=50, verbose_name="Nachname"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "inhalt",
                    models.CharField(
                        blank=True, default="", max_length=250, verbose_name="Inhalt"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="Zusätzliche Kosten", max_length=50, verbose_name="Name"
                    ),
                ),
                ("preis", models.FloatField(default=0.0, verbose_name="Preis")),
                (
                    "versteuerbar",
                    models.BooleanField(default=True, verbose_name="Versteuerbar"),
                ),
            ],
            options={
                "verbose_name": "Kosten",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registrierungsemail_gesendet",
                    models.BooleanField(
                        default=False, verbose_name="Registrierungsemail gesendet?"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "kurzbeschrieb",
                    models.TextField(
                        blank=True, default="", verbose_name="Kurzbeschrieb"
                    ),
                ),
                (
                    "beschrieb",
                ...
                (
                    "packlistenbemerkung",
                    models.TextField(
                        blank=True, default="", verbose_name="Packlistenbemerkung"
                    ),
                ),
                (
                    "aktion_von",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                "^CH[0-9]{2}\\s3[0-9]{3}\\s[0-9]{4}\\s[0-9]{4}\\s[0-9]{4}\\s[0-9]{1}$",
                                "Bite benutze folgendes Format: CHxx 3xxx xxxx xxxx xxxx x",
                            )
                        ],
                ...
                (
                    "firmenname",
                    models.CharField(max_length=70, verbose_name="Firmennname"),
                ),
                (
                    "firmenuid",
                    models.CharField(
        ...
        migrations.AddField(
            ...
            name="produkte",
            field=models.ManyToManyField(
                through="kmuhelper.Lieferungsposten", to="kmuhelper.Produkt"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "produktpreis",
                    models.FloatField(
                        default=0.0, verbose_name="Produktpreis in CHF (exkl. MwSt)"
                    ),
                ),
                (
                    "bestellung",
        ...
        migrations.AddField(
            ...
            name="kosten",
            field=models.ManyToManyField(
                through="kmuhelper.Bestellungskosten", to="kmuhelper.Kosten"
            ),
        ),
        migrations.AddField(
            model_name="bestellung",
        ...
        migrations.AddField(
            ...
            name="produkte",
            field=models.ManyToManyField(
                through="kmuhelper.Bestellungsposten", to="kmuhelper.Produkt"
            ),
        ),
        migrations.AddField(
            model_name="bestellung",
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                to="kmuhelper.Zahlungsempfaenger",
                verbose_name="Zahlungsempfänger",
            ),
        ),
    ]
