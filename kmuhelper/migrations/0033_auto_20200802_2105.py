...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="adresszeile1",
            field=models.CharField(
                max_length=70, verbose_name="Strasse und Hausnummer oder 'Postfach'"
            ),
        ),
        migrations.AlterField(
            model_name="zahlungsempfaenger",
            name="firmenname",
            field=models.CharField(
                help_text="Name der Firma", max_length=70, verbose_name="Firmennname"
            ),
        ),
        migrations.AlterField(
            model_name="zahlungsempfaenger",
        ...
        migrations.AlterField(
            ...
            name="webseite",
            field=models.URLField(
                help_text="Auf der Rechnung ersichtlich!", verbose_name="Webseite"
            ),
        ),
    ]
