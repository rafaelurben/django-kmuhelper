...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='email',
            name='bcc',
            field=multi_email_field.fields.MultiEmailField(blank=True, default='', help_text='Blindkopie', verbose_name='BCC'),
        ),
        migrations.AlterField(
            model_name='email',
            name='cc',
            field=multi_email_field.fields.MultiEmailField(blank=True, default='', help_text='Kopie', verbose_name='CC'),
        ),
        migrations.AlterField(
            model_name='email',
            name='html_context',
        ...
        migrations.AlterField(
            model_name='email',
            name='to',
            field=multi_email_field.fields.MultiEmailField(default=[], help_text='Direkte Empfänger', verbose_name='Empfänger'),
        ),
    ]
